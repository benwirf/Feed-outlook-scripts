...
class Clip_feed_outlook_rasters_by_district(QgsProcessingAlgorithm):
...
#        return results
    ...
    def name(self):
        return 'Clip_feed_outlook_rasters_by_district'

    def displayName(self):
        return 'Clip feed outlook rasters by district'
